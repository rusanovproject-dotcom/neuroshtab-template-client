...
| 3 | **Framer (no-code)** | Быстрый лендинг за 1 день | Старт без кода, клиентские сайты |
...
**Когда брать:** Когда клиент хочет "как у крутого стартапа". SaaS, AI-продукты, креативные агентства.
...
- Social proof: логотипы клиентов, не текстовые отзывы
...
Аудитория: [инвесторы / клиенты / команда]
...
- Клиентский питч-дек с AI: Claude Design
...
**Пример по типу клиента:**

| Клиент | Stack | Почему |
|--------|-------|--------|
| Кофейня | Framer + Fontpair + Coolors | За 1 день, красиво, клиент сам обновляет CMS |
