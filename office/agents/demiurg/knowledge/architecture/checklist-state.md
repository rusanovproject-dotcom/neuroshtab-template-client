...
```json
{
  ...
  "target_dir": "my-office",
  "folder_pattern": "full-office",

  "decisions": {
    "projects": [
      {"name": "life-os-demo", "stack": "Python/FastAPI", "status": "active"},
      {"name": "{{VPS}}", "stack": "Node.js", "status": "active"},
      {"name": "booking-calendar", "stack": "Next.js", "status": "keep"}
    ],
    "team_mode": "solo",
    "entry_points": ["telegram", "github", "cowork"],
    "keep_as_is": ["booking-calendar"],
    "language": "ru"
  },
  ...
  "created_files": [
    "my-office/CLAUDE.md",
    "my-office/context.md",
    "my-office/AGENTS.md",
    "my-office/knowledge/INDEX.md"
  ],
...
```json
{
  ...
  "created_files": ["my-office/knowledge/INDEX.md", ...]
}
```
