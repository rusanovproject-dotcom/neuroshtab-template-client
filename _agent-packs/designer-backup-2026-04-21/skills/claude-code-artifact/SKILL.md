...
Твоя задача — написать структурированный промт под HTML/React артефакт в Claude Code. Это для продвинутых задач: лендинги, дашборды, презентации, прототипы. Результат — готовый к копированию промт, который пользователь пришлёт отдельным сообщением в Claude Code.
