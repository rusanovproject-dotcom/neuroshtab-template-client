...
| `edge-cases.md` | **Справочник пограничных сценариев** — нет Claude Pro, промт не сработал, тип не из каталога, пользователь не копирует промт, несколько проектов, Claude обрезал лендинг, хочу как у чужого сайта, и др. Читать когда ситуация нестандартная. |
