...
Полный пайплайн `/audience-jtbd` = 6-7 сессий по 1.5-2ч. Один контекст не вытянет 7000+ строк диалога — модель деградирует. Resume-pattern разбивает работу на сессии с явной точкой восстановления.
...
## Алгоритм при старте `/audience-jtbd`
...
> *«Накопилось N цитат, M гипотез, J решений. Контекст забивается — давай сохраним прогресс и продолжим новой сессией с `/audience-jtbd --resume`. Нажми `/clear` когда готов.»*
