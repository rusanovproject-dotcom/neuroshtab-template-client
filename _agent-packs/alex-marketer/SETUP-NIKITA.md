# Setup Алекса v2.0 — пошагово для Никиты

> Standalone-гайд для **Никиты Русанова**. Алекс v2.0 — Internet-First пайплайн распаковки ЦА. Чтобы он работал на полной мощности, нужны 3 API-ключа и 2 MCP-сервера. Setup — **~25 минут**, стоимость **$0/мес** на Free tier.
>
