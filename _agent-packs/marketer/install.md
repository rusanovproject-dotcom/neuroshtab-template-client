...
trigger_keywords: [маркетинг, маркетолог, оффер, позиционирование, воронка, рынок, лид-магнит, трипваер, лестница, продуктовая линейка, Hormozi, ревизия, где деньги, avatar, ICP, сегменты, БПСВ, БПКСВ, семь вопросов, awareness, точка входа воронки, разведай конкурентов, анализ рынка, голубой океан, конкурентный анализ, пятничная ревизия, обнови сегмент, стрим в досье, ревизия сегмента]
version: 1.1.0
requires: []
...
updates:
  ...
  - file: office/AGENTS.md
    ...
    add_row: |
      | **Маркетолог** | Клиентская база, тест-процесс гипотез, разбор аудитории, продуктовая линейка, воронка | *«распакуй мою ЦА», «найди сегменты», «провёл диагностику», «разведай конкурентов», «пятничная ревизия»* |
