...
> Выбор типа — первый шаг любой задачи на дизайн. Запрос клиента → нахожу ближайший тип → определяю стек → пишу промт.
...
**Когда:** клиент хочет видеть свои цели, метрики, задачи недели одной страницей. Визуальная мотивация + функциональный контроль.
...
## 8. Клиентское КП (коммерческое предложение)

**Когда:** документ для клиента B2B — структурированное предложение с ценой.
...
1. Уточни у клиента формат: "Это статичная картинка или интерактив? Куда пойдёт — в PDF, на сайт, в соцсети, в презентацию?"
