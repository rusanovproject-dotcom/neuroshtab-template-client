...
**Пример:**
```markdown
- 2026-04-15 — пользователь предпочитает короткие сообщения
- 2026-04-22 — короткие сообщения предпочтение пользователя  ← дубль того же факта
...
**Пример:**
```markdown
- yesterday пользователь решил перенести релиз     ← stale, дата размылась
```
