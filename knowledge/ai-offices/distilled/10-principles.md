...
**Anti-pattern.** «Я сам себя проверил, всё ок.» Проходишь свой же тест — слепые пятна остаются. Демиург не сделал dogfooding (не запустил собственный `/office-architect scan` на своём паке) — пропустил 4 P0 блокера.
